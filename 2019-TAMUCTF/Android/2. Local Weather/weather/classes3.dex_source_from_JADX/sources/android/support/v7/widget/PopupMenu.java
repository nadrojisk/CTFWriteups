...
public class PopupMenu {
    ...
    class C01462 implements android.widget.PopupWindow.OnDismissListener {
        C01462() {
        }
    ...
    class C02131 implements Callback {
        C02131() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02131());
        ...
        this.mPopup.setOnDismissListener(new C01462());
    }
