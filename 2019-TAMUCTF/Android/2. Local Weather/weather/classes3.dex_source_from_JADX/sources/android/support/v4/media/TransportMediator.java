...
public class TransportMediator extends TransportController {
    ...
    class C00562 implements Callback {
        C00562() {
        }
    ...
    class C01761 implements TransportMediatorCallback {
        C01761() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01761();
        this.mKeyEventCallback = new C00562();
