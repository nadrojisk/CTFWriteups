...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02221();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02232();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02063();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C02063 implements ViewPropertyAnimatorUpdateListener {
        C02063() {
        }
    ...
    class C02232 extends ViewPropertyAnimatorListenerAdapter {
        C02232() {
        }
