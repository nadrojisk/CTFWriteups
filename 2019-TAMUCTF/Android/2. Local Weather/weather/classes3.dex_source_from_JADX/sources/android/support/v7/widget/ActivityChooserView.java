...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01371 extends DataSetObserver {
        C01371() {
        }
    ...
    class C01382 implements OnGlobalLayoutListener {
        C01382() {
        }
    ...
    class C01394 extends DataSetObserver {
        C01394() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C01371();
        this.mOnGlobalLayoutListener = new C01382();
        ...
        this.mAdapter.registerDataSetObserver(new C01394());
