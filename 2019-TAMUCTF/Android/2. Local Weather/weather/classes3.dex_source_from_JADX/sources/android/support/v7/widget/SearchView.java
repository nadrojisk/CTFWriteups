...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01514 implements OnFocusChangeListener {
        C01514() {
        }
    ...
    class C01525 implements OnLayoutChangeListener {
        C01525() {
        }
    ...
    class C01536 implements OnGlobalLayoutListener {
        C01536() {
        }
    ...
    class C01547 implements OnClickListener {
        C01547() {
        }
    ...
    class C01558 implements OnKeyListener {
        C01558() {
        }
    ...
    class C01569 implements OnEditorActionListener {
        C01569() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02151());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C02151 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02151() {
            }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01481();
        this.mUpdateDrawableStateRunnable = new C01492();
        this.mReleaseCursorRunnable = new C01503();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01547();
        this.mTextKeyListener = new C01558();
        this.mOnEditorActionListener = new C01569();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01514());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01525());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01536());
    }
