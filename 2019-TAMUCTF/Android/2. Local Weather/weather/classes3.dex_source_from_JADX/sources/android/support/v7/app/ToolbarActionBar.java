...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02052();
    private final Runnable mMenuInvalidator = new C01271();
    ...
    class C02052 implements OnMenuItemClickListener {
        C02052() {
        }
