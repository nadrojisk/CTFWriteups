...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00681();
    ...
    static class C00681 implements Creator<PlaybackStateCompat> {
        C00681() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00691();
        ...
        static class C00691 implements Creator<CustomAction> {
            C00691() {
            }
