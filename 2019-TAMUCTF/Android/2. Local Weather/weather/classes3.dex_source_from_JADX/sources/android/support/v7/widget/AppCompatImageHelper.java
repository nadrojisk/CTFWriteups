...
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x003b in list [B:12:0x0038]
	...
	at jadx.api.JadxDecompiler$$Lambda$6/157683534.run(Unknown Source)
*/
        /*
        r7 = this;
        r6 = -1;
    ...
    L_0x000a:
        ...
        r4 = android.support.v7.appcompat.R.styleable.AppCompatImageView;	 Catch:{ all -> 0x003c }
        r5 = 0;	 Catch:{ all -> 0x003c }
        r0 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r3, r8, r4, r9, r5);	 Catch:{ all -> 0x003c }
        r3 = android.support.v7.appcompat.R.styleable.AppCompatImageView_srcCompat;	 Catch:{ all -> 0x003c }
