...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00301();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01692();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00301 implements ThreadFactory {
    ...
    class C01692 extends WorkerRunnable<Params, Result> {
        C01692() {
        }
