...
public class Toolbar extends ViewGroup {
    ...
    class C01593 implements OnClickListener {
        C01593() {
        }
    ...
    class C02161 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02161() {
        }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02161();
        this.mShowOverflowMenuRunnable = new C01582();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C01593());
        }
    }
