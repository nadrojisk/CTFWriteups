...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00604();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00615();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00593();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00626();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00571();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00582();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C00571 implements OnWindowAttachListener {
        C00571() {
        }
    ...
    class C00582 implements OnWindowFocusChangeListener {
        C00582() {
        }
    ...
    class C00604 implements OnAudioFocusChangeListener {
        C00604() {
        }
    ...
    class C00615 implements OnGetPlaybackPositionListener {
        C00615() {
        }
    ...
    class C00626 implements OnPlaybackPositionUpdateListener {
        C00626() {
        }
