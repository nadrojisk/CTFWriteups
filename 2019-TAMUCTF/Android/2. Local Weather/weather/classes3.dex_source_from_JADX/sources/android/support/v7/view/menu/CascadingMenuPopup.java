...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C01281();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C02072();
    ...
    class C02072 implements MenuItemHoverListener {
        C02072() {
        }
