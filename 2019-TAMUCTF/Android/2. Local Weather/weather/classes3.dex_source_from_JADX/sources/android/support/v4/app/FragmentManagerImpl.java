...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00151();
    ...
    public void popBackStack() {
        enqueueAction(new C00162(), false);
    }
    ...
    L_0x029d:
        ...
        if (r4 != 0) goto L_0x02ed;
    L_0x02a3:
        r4 = r18.getResources();	 Catch:{ NotFoundException -> 0x041c }
        r0 = r18;
        r5 = r0.mContainerId;	 Catch:{ NotFoundException -> 0x041c }
        r14 = r4.getResourceName(r5);	 Catch:{ NotFoundException -> 0x041c }
    L_0x02af:
        r4 = new java.lang.IllegalArgumentException;
        r5 = new java.lang.StringBuilder;
        r5.<init>();
    ...
    L_0x0027:
        monitor-enter(r5);
        r3 = r5.mPendingActions;	 Catch:{ all -> 0x0079 }
        if (r3 == 0) goto L_0x0034;
    L_0x002c:
        r3 = r5.mPendingActions;	 Catch:{ all -> 0x0079 }
        r3 = r3.size();	 Catch:{ all -> 0x0079 }
    ...
    L_0x0039:
        r3 = r5.mPendingActions;	 Catch:{ all -> 0x0079 }
        r2 = r3.size();	 Catch:{ all -> 0x0079 }
        r3 = r5.mTmpActions;	 Catch:{ all -> 0x0079 }
    ...
    L_0x0048:
        r3 = new java.lang.Runnable[r2];	 Catch:{ all -> 0x0079 }
        r5.mTmpActions = r3;	 Catch:{ all -> 0x0079 }
    L_0x004c:
        r3 = r5.mPendingActions;	 Catch:{ all -> 0x0079 }
        r4 = r5.mTmpActions;	 Catch:{ all -> 0x0079 }
        r3.toArray(r4);	 Catch:{ all -> 0x0079 }
        r3 = r5.mPendingActions;	 Catch:{ all -> 0x0079 }
        r3.clear();	 Catch:{ all -> 0x0079 }
        r3 = r5.mHost;	 Catch:{ all -> 0x0079 }
        r3 = r3.getHandler();	 Catch:{ all -> 0x0079 }
        r4 = r5.mExecCommit;	 Catch:{ all -> 0x0079 }
        r3.removeCallbacks(r4);	 Catch:{ all -> 0x0079 }
        monitor-exit(r5);	 Catch:{ all -> 0x0079 }
        r3 = 1;
